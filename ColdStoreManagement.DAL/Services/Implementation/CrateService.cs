...
namespace ColdStoreManagement.DAL.Services.Implementation
{
    public class CrateService : BaseService, ICrateService
    {
        ...
        public async Task<List<CrateModel>> GenerateCrateReportAsync(CrateModel model)
        {
        ...
        public async Task<List<CrateModel>> GetCrateSummaryMainAsync()
        {
        ...
        public async Task<List<CrateModel>> CheckCratesPartyOutAsync(string growerGroupName, string flag)
        {
        ...
        public async Task<List<CrateModel>> CheckCratesPartySubOutAsync(string growerName, string growerGroupName, string flag)
        {
            List<CrateModel> result = new List<CrateModel>();
            try
            {
